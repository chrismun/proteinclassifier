...
train_loader = DataLoader(dataset=train_dataset, batch_size=4, shuffle=True, num_workers=2, drop_last=True)
test_loader = DataLoader(dataset=test_dataset, batch_size=4, shuffle=False, num_workers=2, drop_last=True)
