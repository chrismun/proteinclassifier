...
source activate pyuul
#conda install -c grogdrinker pyuul
#srun --export=ALL python3 chris-train-nogpu.py
srun --export=ALL python3 test.py
#
# [EDIT] Add your script statements hereafter, or execute a script or program
#        using the srun command.
#
#srun --export=ALL python3 infrastructure.py -c=init_config-nvc.txt -o=outputvv
